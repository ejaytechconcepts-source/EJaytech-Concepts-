...
export default function Home({ onNavigate, onSelectCourse }: HomeProps) {
  ...
  return (
    <div className="space-y-24 pb-16">
        ...
        <div className="relative max-w-5xl mx-auto flex flex-col md:flex-row items-center md:justify-between gap-12">
          <div className="flex-1 space-y-6 text-center md:text-left">
            ...
            <p className="text-lg text-gray-300 max-w-2xl leading-relaxed">
              EJaytech Concepts provides innovative web development, graphic design, branding, IT support, and expert practical learning tracks tailored to your career and corporate business needs.
            </p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-brand-primary tracking-tight">
              Why Businesses & Students Rely on EJaytech Concepts
            </h2>
      ...
      <section className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-12">
          <div className="space-y-3">
            <h2 className="text-3xl font-bold text-slate-900 tracking-tight">Our Portfolio Projects</h2>
          ...
          <button 
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-slate-900 hover:bg-brand-secondary text-white hover:text-brand-primary font-bold rounded-xl transition duration-300 cursor-pointer"
          >
      ...
      <section className="max-w-7xl mx-auto px-6">
        <div className="text-center space-y-4 mb-16">
          <h2 className="text-3xl font-bold text-slate-900">What Our Graduates & Clients Say</h2>
          <p className="text-gray-600 max-w-xl mx-auto">
            From zero coding knowledge to securing international freelance contracts—listen to live testimonials.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t, idx) => (
            <div key={idx} className="bg-brand-accent rounded-2xl p-8 relative flex flex-col justify-between">
